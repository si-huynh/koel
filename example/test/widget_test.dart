...
import 'package:koel_example/main.dart';
import 'package:koel_widgets/koel_widgets.dart' show MessageBubble;

void main() {
  // Architecture §6 smoke: the example builds and runs its seed turn to
  ...
  // what gets exercised, including the meta-package import path.
  testWidgets('example app builds, settles, and renders bubbles', (
    tester,
  ) async {
    await tester.pumpWidget(const KoelExampleApp());
