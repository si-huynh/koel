...
/// NFR-3 baseline harness: p99 of the resident-set growth a **single active
...
/// [ProcessInfo.currentRss] before/after each run, and records the 99th
/// percentile of the per-run delta. A fixed sequence bounds the conversation, so
/// the metric reflects koel's steady footprint, **not** the unbounded
/// consumer-held message history N-3 explicitly excludes.
///
